...
**Surface:** both · **UX gate:** FINAL emulator full-app · **On green:** auto → Phase 10 launch foundation
**Shared conventions:** [README.md](./README.md).

## 0. Prerequisite gate (validate Phase 8 done)
README gate + confirm **all** prior phases green (Phases 0–8 integration tests pass on the Flutter Android emulator) and the app runs the full surface on the emulator. This phase closes the export/transparency loop and runs the whole-app emulator audits. Physical Android phone validation is now deferred to Phase 26.
...
- Phase 9 validates the full export/transparency demo on the Flutter Android emulator. Phase 26 is the physical Android phone validation phase.
...
- The author→consume loop and six-step wow demo run end-to-end, fully offline, on the Android emulator. Physical-phone validation is completed in Phase 26.
...
## 11. Next phase
Proceed to [Phase 10 — Launch Contracts, Store & Fakes](./Phase%2010%20-%20Launch%20Contracts%20Store%20and%20Fakes.md) to start the launch-demo sequence. Final manual UX validation and physical Android phone sign-off happen in [Phase 26 — Gaming Seed Showcase and Final Validation](./Phase%2026%20-%20Gaming%20Seed%20Showcase%20and%20Final%20Validation.md).
