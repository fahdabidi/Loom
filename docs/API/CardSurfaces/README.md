...
| Equipment loan | `CommunityEquipmentLoanApi` | `offerEquipment`, `requestLoan`, `approveLoan`, `declineLoan`, `schedulePickup`, `checkOut`, `extendLoan`, `returnItem`, `markDamaged`, `cancelLoan`, `listAvailability`, `privacyScopedContact` |
