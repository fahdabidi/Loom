...
Set A phases add one guide per built component.
...
- Owned data and export notes.
- Recipes for extension builders.
- Gotchas beyond OpenAPI.
- Minimal snippet or manifest fragment.
- Validation and consumer-contract tests.

## Phase A1 Guides

- [passport-ledger.md](./passport-ledger.md)
- [role-policy-consent-engine.md](./role-policy-consent-engine.md)
- [core-member-vault.md](./core-member-vault.md)
- [protected-visibility-vault.md](./protected-visibility-vault.md)
- [connections-graph.md](./connections-graph.md)
- [receipt-ledger.md](./receipt-ledger.md)
