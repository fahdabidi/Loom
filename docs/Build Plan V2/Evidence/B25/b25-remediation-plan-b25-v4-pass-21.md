...
| Status | `open` |
| Source tickets | `../docs/Build Plan V2/Evidence/B25/b25-remediation-tickets-b25-v4-pass-20.json` |
| Ticket count | 7 |
| Scorecard status | `fail` |
| Remaining blocker/major | 4 |
| Blocking criteria failures | 7 |
| Product spec work items | 6 |
| Evidence repair work items | 26 |
| UI remediation work items | 27 |
...
| --- | --- |
| Status | open |
| Ticket IDs | B25-RT-002-b25-c03-production-grade-experience, B25-RT-004-b25-c04-modern-intentional-ui, B25-RT-007-b25-c09-no-layout-production-defects |
...
Showing 4 of 4 affected screen rows.
...
| `b25-v4-row-141-ad-off-member-checkout-2` | Ad-Free Community | `ad-off-member-checkout` | member | B16_ext_ad_off_ad-off-member-checkout_complete | No row-specific failure recorded. |
| `b25-v4-row-183-export-transfer-rollback-2` | Data Portability Community | `export-transfer-rollback` | owner | B16_ext_export_migration_export-transfer-rollback_complete | No row-specific failure recorded. |
...
| --- | --- |
| Status | open |
| Ticket IDs | B25-RT-004-b25-c04-modern-intentional-ui, B25-RT-005-b25-c05-community-content-ia, B25-RT-007-b25-c09-no-layout-production-defects |
...
| --- | --- |
| Status | open |
| Ticket IDs | B25-RT-001-b25-c01-no-blocker-major, B25-RT-002-b25-c03-production-grade-experience, B25-RT-003-b25-c14-llm-vision-ux-review, B25-RT-004-b25-c04-modern-intentional-ui, B25-RT-005-b25-c05-community-content-ia, B25-RT-006-b25-c13-workflow-lifecycle-complete, B25-RT-007-b25-c09-no-layout-production-defects |
...
Showing 27 of 27 work items. Full detail is in the JSON artifact.
...
Showing 26 of 26 affected coverage rows.
...
Showing 30 of 79 affected screen rows.
