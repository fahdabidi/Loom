...
| Status | `open` |
| Source tickets | `../docs/Build Plan V2/Evidence/B25/b25-remediation-tickets-b25-v4-pass-33.json` |
| Ticket count | 9 |
| Scorecard status | `fail` |
| Remaining blocker/major | 5 |
...
| --- | --- | --- | --- | --- | --- |
| `b25-v4-row-001-garden-event-rsvp-0` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_start | LLM vision critique: Garden Club / garden-event-rsvp / member shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-002-garden-event-rsvp-1` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_action | LLM vision critique: Garden Club / garden-event-rsvp / member shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-003-garden-event-rsvp-2` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_complete | LLM vision critique: Garden Club / garden-event-rsvp / member shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-004-plant-exchange-submission-0` | Garden Club | `plant-exchange-submission` | member | B13_ext_garden_club_plant-exchange-submission_start | LLM vision critique: Garden Club / plant-exchange-submission / member shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-005-plant-exchange-submission-1` | Garden Club | `plant-exchange-submission` | member | B13_ext_garden_club_plant-exchange-submission_action | LLM vision critique: Garden Club / plant-exchange-submission / member shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-006-plant-exchange-submission-2` | Garden Club | `plant-exchange-submission` | member | B13_ext_garden_club_plant-exchange-submission_complete | LLM vision critique: Garden Club / plant-exchange-submission / member shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-007-garden-export-custom-schemas-0` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_start | LLM vision critique: Garden Club / garden-export-custom-schemas / owner shows stronger domain content than prior passes. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-008-garden-export-custom-schemas-1` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_action | LLM vision critique: Garden Club / garden-export-custom-schemas / owner shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-009-garden-export-custom-schemas-2` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_complete | LLM vision critique: Garden Club / garden-export-custom-schemas / owner shows stronger domain content than prior passes. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-010-book-nomination-0` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_start | LLM vision critique: Neighborhood Book Club / book-nomination / member shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-011-book-nomination-1` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_action | LLM vision critique: Neighborhood Book Club / book-nomination / member shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-012-book-nomination-2` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_complete | LLM vision critique: Neighborhood Book Club / book-nomination / member shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-013-book-selection-publish-0` | Neighborhood Book Club | `book-selection-publish` | owner | B14_ext_book_club_book-selection-publish_start | LLM vision critique: Neighborhood Book Club / book-selection-publish / owner shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-014-book-selection-publish-1` | Neighborhood Book Club | `book-selection-publish` | owner | B14_ext_book_club_book-selection-publish_action | LLM vision critique: Neighborhood Book Club / book-selection-publish / owner shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-015-book-selection-publish-2` | Neighborhood Book Club | `book-selection-publish` | owner | B14_ext_book_club_book-selection-publish_complete | LLM vision critique: Neighborhood Book Club / book-selection-publish / owner shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-016-soccer-team-roster-0` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_start | LLM vision critique: Riverside Youth Soccer / soccer-team-roster / coach shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-017-soccer-team-roster-1` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_action | LLM vision critique: Riverside Youth Soccer / soccer-team-roster / coach shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-018-soccer-team-roster-2` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_complete | LLM vision critique: Riverside Youth Soccer / soccer-team-roster / coach shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-019-soccer-reminder-notification-0` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_start | LLM vision critique: Riverside Youth Soccer / soccer-reminder-notification / guardian shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-020-soccer-reminder-notification-1` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_action | LLM vision critique: Riverside Youth Soccer / soccer-reminder-notification / guardian shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-021-soccer-reminder-notification-2` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_complete | LLM vision critique: Riverside Youth Soccer / soccer-reminder-notification / guardian shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-022-hoa-facility-reservation-0` | Cedar Commons HOA | `hoa-facility-reservation` | member | B14_ext_hoa_hoa-facility-reservation_start | LLM vision critique: Cedar Commons HOA / hoa-facility-reservation / member shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-023-hoa-facility-reservation-1` | Cedar Commons HOA | `hoa-facility-reservation` | member | B14_ext_hoa_hoa-facility-reservation_action | LLM vision critique: Cedar Commons HOA / hoa-facility-reservation / member shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-024-hoa-facility-reservation-2` | Cedar Commons HOA | `hoa-facility-reservation` | member | B14_ext_hoa_hoa-facility-reservation_complete | LLM vision critique: Cedar Commons HOA / hoa-facility-reservation / member shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-025-hoa-export-evidence-0` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_start | LLM vision critique: Cedar Commons HOA / hoa-export-evidence / owner shows stronger domain content than prior passes. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-026-hoa-export-evidence-1` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_action | LLM vision critique: Cedar Commons HOA / hoa-export-evidence / owner shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-027-hoa-export-evidence-2` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_complete | LLM vision critique: Cedar Commons HOA / hoa-export-evidence / owner shows stronger domain content than prior passes. This utility/product family still relies on status/checklist card structure instead of a specialized product layout. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-028-mosque-donor-visibility-0` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_start | LLM vision critique: Masjid Nur / mosque-donor-visibility / donor shows stronger domain content than prior passes. The row does not by itself prove persona-custom tabs, pinned cards, and minimized/medium/expanded navigation. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-029-mosque-donor-visibility-1` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_action | LLM vision critique: Masjid Nur / mosque-donor-visibility / donor shows stronger domain content than prior passes. The action/review state still appears as a dimmed modal-style workflow surface rather than a durable full-bright product screen. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-030-mosque-donor-visibility-2` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_complete | LLM vision critique: Masjid Nur / mosque-donor-visibility / donor shows stronger domain content than prior passes. Lifecycle options are visible in some form, but the required domain-specific continuation paths are not fully proven. LLM required fix: Apply the associated finding fixes and recapture this row with fresh hash/timestamp. Current row verdict is `fail` with severity `major`. |
