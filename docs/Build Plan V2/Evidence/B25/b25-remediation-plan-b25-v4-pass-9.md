...
| Status | `open` |
| Source tickets | `../docs/Build Plan V2/Evidence/B25/b25-remediation-tickets-b25-v4-pass-8.json` |
| Ticket count | 7 |
...
| `b25-v4-row-032-soccer-guardian-join-approval-1` | Riverside Youth Soccer | `soccer-guardian-join-approval` | guardian | B14_ext_youth_soccer_soccer-guardian-join-approval_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-034-soccer-team-roster-0` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-035-soccer-team-roster-1` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-036-soccer-team-roster-2` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_complete | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-038-soccer-minor-redaction-1` | Riverside Youth Soccer | `soccer-minor-redaction` | guardian | B14_ext_youth_soccer_soccer-minor-redaction_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-040-soccer-registration-payment-0` | Riverside Youth Soccer | `soccer-registration-payment` | guardian | B14_ext_youth_soccer_soccer-registration-payment_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-041-soccer-registration-payment-1` | Riverside Youth Soccer | `soccer-registration-payment` | guardian | B14_ext_youth_soccer_soccer-registration-payment_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-044-soccer-practice-schedule-1` | Riverside Youth Soccer | `soccer-practice-schedule` | guardian | B14_ext_youth_soccer_soccer-practice-schedule_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-046-soccer-reminder-notification-0` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-047-soccer-reminder-notification-1` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-050-soccer-export-metadata-1` | Riverside Youth Soccer | `soccer-export-metadata` | owner | B14_ext_youth_soccer_soccer-export-metadata_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-052-hoa-dues-payment-0` | Cedar Commons HOA | `hoa-dues-payment` | member | B14_ext_hoa_hoa-dues-payment_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-053-hoa-dues-payment-1` | Cedar Commons HOA | `hoa-dues-payment` | member | B14_ext_hoa_hoa-dues-payment_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
...
| `b25-v4-row-001-garden-event-rsvp-0` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-002-garden-event-rsvp-1` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-003-garden-event-rsvp-2` | Garden Club | `garden-event-rsvp` | member | B13_ext_garden_club_garden-event-rsvp_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-004-plant-exchange-submission-0` | Garden Club | `plant-exchange-submission` | member | B13_ext_garden_club_plant-exchange-submission_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-005-plant-exchange-submission-1` | Garden Club | `plant-exchange-submission` | member | B13_ext_garden_club_plant-exchange-submission_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
...
| `b25-v4-row-007-garden-export-custom-schemas-0` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-008-garden-export-custom-schemas-1` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-009-garden-export-custom-schemas-2` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-010-book-nomination-0` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-011-book-nomination-1` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-012-book-nomination-2` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-013-book-vote-0` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_start | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-014-book-vote-1` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-015-book-vote-2` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-016-book-meeting-rsvp-0` | Neighborhood Book Club | `book-meeting-rsvp` | member | B14_ext_book_club_book-meeting-rsvp_start | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-017-book-meeting-rsvp-1` | Neighborhood Book Club | `book-meeting-rsvp` | member | B14_ext_book_club_book-meeting-rsvp_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-018-book-meeting-rsvp-2` | Neighborhood Book Club | `book-meeting-rsvp` | member | B14_ext_book_club_book-meeting-rsvp_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
...
| `b25-v4-row-025-book-search-ai-digest-0` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-026-book-search-ai-digest-1` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-027-book-search-ai-digest-2` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
| `b25-v4-row-028-book-export-metadata-0` | Neighborhood Book Club | `book-export-metadata` | owner | B14_ext_book_club_book-export-metadata_start | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-029-book-export-metadata-1` | Neighborhood Book Club | `book-export-metadata` | owner | B14_ext_book_club_book-export-metadata_action | Primary surface classification is incomplete or unverified. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-030-book-export-metadata-2` | Neighborhood Book Club | `book-export-metadata` | owner | B14_ext_book_club_book-export-metadata_complete | Ticket must add screenshot-backed visible text and a non-reusable critique for this exact screen. |
