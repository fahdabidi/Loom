...
| Status | `open` |
| Source tickets | `../docs/Build Plan V2/Evidence/B25/b25-remediation-tickets-b25-v4-pass-41.json` |
| Ticket count | 2 |
...
| `B25-RT-002-app-shell-capability-gap` | `b25-c16-app-shell-capability-utilization` | major | open | App Shell capabilities are used where documented |
...
| --- | --- |
| Status | open |
| Ticket IDs | B25-RT-001-b25-c14-llm-vision-ux-review, B25-RT-002-app-shell-capability-gap |
