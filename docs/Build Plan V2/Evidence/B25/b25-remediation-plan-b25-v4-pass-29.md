...
| Status | `open` |
| Source tickets | `../docs/Build Plan V2/Evidence/B25/b25-remediation-tickets-b25-v4-pass-28.json` |
| Ticket count | 9 |
| Scorecard status | `fail` |
| Remaining blocker/major | 38 |
...
Showing 30 of 47 work items. Full detail is in the JSON artifact.
...
| `b25-wi-evidence-repair-community-export-migration-export-transfer-verification-community-export-migration-owner` | `evidence-repair` | Data Portability Community | `export-transfer-verification` | owner | 3 | 1 | export/import wizard with preview, redaction, checksum, transfer status, and rollback state |  |
...
Showing 30 of 47 affected coverage rows.
...
| `b25-wp-045-export-full-bundle-community-export-migration-owner` | Data Portability Community | `export-full-bundle` | owner |  |
| `b25-wp-046-export-transfer-verification-community-export-migration-owner` | Data Portability Community | `export-transfer-verification` | owner |  |
...
Showing 30 of 162 affected screen rows.

| Screen row | Community | Workflow | Persona | State | Exact UX failure |
| --- | --- | --- | --- | --- | --- |
| `b25-v4-row-008-garden-export-custom-schemas-1` | Garden Club | `garden-export-custom-schemas` | owner | B13_ext_garden_club_garden-export-custom-schemas_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-011-book-nomination-1` | Neighborhood Book Club | `book-nomination` | member | B14_ext_book_club_book-nomination_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-014-book-selection-publish-1` | Neighborhood Book Club | `book-selection-publish` | owner | B14_ext_book_club_book-selection-publish_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-016-soccer-team-roster-0` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_start | LLM required fix: None. |
| `b25-v4-row-017-soccer-team-roster-1` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_action | LLM required fix: None. |
| `b25-v4-row-018-soccer-team-roster-2` | Riverside Youth Soccer | `soccer-team-roster` | coach | B14_ext_youth_soccer_soccer-team-roster_complete | LLM required fix: None. |
| `b25-v4-row-019-soccer-reminder-notification-0` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_start | LLM required fix: None. |
| `b25-v4-row-020-soccer-reminder-notification-1` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_action | LLM required fix: None. |
| `b25-v4-row-021-soccer-reminder-notification-2` | Riverside Youth Soccer | `soccer-reminder-notification` | guardian | B14_ext_youth_soccer_soccer-reminder-notification_complete | LLM required fix: None. |
| `b25-v4-row-023-hoa-facility-reservation-1` | Cedar Commons HOA | `hoa-facility-reservation` | member | B14_ext_hoa_hoa-facility-reservation_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-025-hoa-export-evidence-0` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_start | LLM required fix: None. |
| `b25-v4-row-026-hoa-export-evidence-1` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-027-hoa-export-evidence-2` | Cedar Commons HOA | `hoa-export-evidence` | owner | B14_ext_hoa_hoa-export-evidence_complete | LLM required fix: None. |
| `b25-v4-row-028-mosque-donor-visibility-0` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_start | LLM required fix: None. |
| `b25-v4-row-029-mosque-donor-visibility-1` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-030-mosque-donor-visibility-2` | Masjid Nur | `mosque-donor-visibility` | donor | B14_ext_mosque_mosque-donor-visibility_complete | LLM required fix: None. |
| `b25-v4-row-031-mosque-search-ai-citation-0` | Masjid Nur | `mosque-search-ai-citation` | member | B14_ext_mosque_mosque-search-ai-citation_start | LLM required fix: None. |
| `b25-v4-row-032-mosque-search-ai-citation-1` | Masjid Nur | `mosque-search-ai-citation` | member | B14_ext_mosque_mosque-search-ai-citation_action | LLM required fix: None. |
| `b25-v4-row-033-mosque-search-ai-citation-2` | Masjid Nur | `mosque-search-ai-citation` | member | B14_ext_mosque_mosque-search-ai-citation_complete | LLM required fix: None. |
| `b25-v4-row-034-book-vote-0` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_start | LLM required fix: None. |
| `b25-v4-row-035-book-vote-1` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-036-book-vote-2` | Neighborhood Book Club | `book-vote` | member | B14_ext_book_club_book-vote_complete | LLM required fix: None. |
| `b25-v4-row-037-book-search-ai-digest-0` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_start | LLM required fix: None. |
| `b25-v4-row-038-book-search-ai-digest-1` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_action | LLM required fix: None. |
| `b25-v4-row-039-book-search-ai-digest-2` | Neighborhood Book Club | `book-search-ai-digest` | member | B14_ext_book_club_book-search-ai-digest_complete | LLM required fix: None. |
| `b25-v4-row-040-soccer-minor-redaction-0` | Riverside Youth Soccer | `soccer-minor-redaction` | guardian | B14_ext_youth_soccer_soccer-minor-redaction_start | LLM required fix: None. |
| `b25-v4-row-041-soccer-minor-redaction-1` | Riverside Youth Soccer | `soccer-minor-redaction` | guardian | B14_ext_youth_soccer_soccer-minor-redaction_action | LLM required fix: None. |
| `b25-v4-row-042-soccer-minor-redaction-2` | Riverside Youth Soccer | `soccer-minor-redaction` | guardian | B14_ext_youth_soccer_soccer-minor-redaction_complete | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
| `b25-v4-row-043-soccer-export-metadata-0` | Riverside Youth Soccer | `soccer-export-metadata` | owner | B14_ext_youth_soccer_soccer-export-metadata_start | LLM required fix: None. |
| `b25-v4-row-044-soccer-export-metadata-1` | Riverside Youth Soccer | `soccer-export-metadata` | owner | B14_ext_youth_soccer_soccer-export-metadata_action | LLM required fix: Replace generic review language with a workflow-specific production surface, hierarchy, fields, and actions. Current row verdict is `fail` with severity `major`. |
...
| Work item | Stage | Community | Workflow | Persona | Screens | Coverage | Target surface | Blocked until |
| --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| `b25-wi-product-spec-interaction-model-riverside-youth-soccer` | `product-spec-update` | Riverside Youth Soccer | `soccer-team-roster, soccer-reminder-notification, soccer-minor-redaction, soccer-export-metadata, soccer-registration-payment, soccer-practice-schedule` | product-experience-steward | 18 | 6 | community product experience spec with semantic interaction models | the product doc defines expected decision, required actions, result state, and receiver/continuation state for each failing workflow |
| `b25-wi-product-spec-interaction-model-cedar-commons-hoa` | `product-spec-update` | Cedar Commons HOA | `hoa-export-evidence, hoa-owner-notification` | product-experience-steward | 6 | 2 | community product experience spec with semantic interaction models | the product doc defines expected decision, required actions, result state, and receiver/continuation state for each failing workflow |
| `b25-wi-product-spec-interaction-model-masjid-nur` | `product-spec-update` | Masjid Nur | `mosque-donor-visibility, mosque-search-ai-citation, mosque-donation-payment, mosque-neutral-notification` | product-experience-steward | 12 | 4 | community product experience spec with semantic interaction models | the product doc defines expected decision, required actions, result state, and receiver/continuation state for each failing workflow |
| `b25-wi-product-spec-interaction-model-neighborhood-book-club` | `product-spec-update` | Neighborhood Book Club | `book-vote, book-search-ai-digest, book-export-metadata` | product-experience-steward | 9 | 3 | community product experience spec with semantic interaction models | the product doc defines expected decision, required actions, result state, and receiver/continuation state for each failing workflow |
...
| `b25-wi-product-spec-interaction-model-export-and-migration` | `product-spec-update` | Data Portability Community | `export-full-bundle, export-protected-redaction, export-schema-listing, export-checksum-evidence` | product-experience-steward | 12 | 4 | community product experience spec with semantic interaction models | the product doc defines expected decision, required actions, result state, and receiver/continuation state for each failing workflow |
