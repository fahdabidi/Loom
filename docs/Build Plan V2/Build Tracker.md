...
- **Current v4 pass:** `b25-v4-pass-1` has collected schema v4 evidence through
  ...
  workflow/persona scorecards are not complete. Pass 1 closes with schema v3 tickets that include
  ...
  production surfaces, 70 evidence-repair work items, 70 UI-remediation work items, likely files/widgets,
  and concrete screen/workflow/persona acceptance criteria. The next worker iteration must start from
  ...
  implement matching UI-remediation work items. B25 remains reopened. Iteration commit: `647c38f`;
