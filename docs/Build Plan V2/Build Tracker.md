...
| B25 | None | Reopened | Product-UX v4 pass 21 failed with 4 unresolved major findings and 9 remediation tickets. Pass 22 must start from `b25-remediation-plan-b25-v4-pass-22.md`, update community Product Docs V2 against exact workflow IDs/persona states, fix 22 lifecycle proof rows, repair B20 CTA wrapping, make Camera/Platform/Ad-Free surfaces visibly domain-specific, recapture full B12-B20 evidence, rerun fresh LLM Product Docs reconciliation and Vision UX review, and regenerate tickets/scorecard. |
