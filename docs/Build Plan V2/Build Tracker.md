...
- **Gate evidence:** Historical v3 checks passed:
  ...
  pending.
- **Current v4 pass:** `b25-v4-pass-9` consumed the pass-8 remediation plan, replaced the remaining
  ...
  blocker/major findings. B25 is complete after the pass-9 commit is stamped.
