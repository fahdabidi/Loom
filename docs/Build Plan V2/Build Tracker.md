...
| B25 | None | Reopened | Product-UX v4 pass 20 failed with 4 unresolved major findings and 7 remediation tickets. Pass 21 must start from `b25-remediation-plan-b25-v4-pass-21.md`, update community Product Docs V2 against exact workflow IDs/persona states, implement remaining product-surface and lifecycle fixes, recapture full B12-B20 evidence, rerun fresh LLM Product Docs reconciliation and Vision UX review, and regenerate tickets/scorecard. |
