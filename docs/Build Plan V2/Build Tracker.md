...
| B1b | `7825b59` | Complete - R20 closeout pending commit stamp | Recreated real-backend-publish, certification, permission review, QR/handle discovery, install preview, and latest-certified open UX decisions using R20. |
