...
| 1 | 1.18 Tournament + Voting feature (flagship) | `[~]` In progress — Stage 1 closed (102/102+28/28, `955268d`+`2a62d0a`); Stage 2a ballot engine model closed 2026-07-13 (105/105, `af9d9ec`: real formula-computed tally/tie/winner, real runoff instance, real cross-instance propagation); Stage 2b (app-shell UI) + live emulator walk still pending (see phase doc) |
