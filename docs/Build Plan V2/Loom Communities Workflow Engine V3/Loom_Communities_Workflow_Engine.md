...
| 1 | 1.20 Human sign-off gate (manual) | `[ ]` **Ready for review** — every milestone above (1.1-1.19) is now `[x]`. This is a manual gate: presented to the user, not closeable by the verification agent (see phase doc) |
