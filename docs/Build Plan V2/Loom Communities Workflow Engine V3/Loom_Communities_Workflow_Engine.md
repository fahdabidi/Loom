...
| 1 | 1.18 Tournament + Voting feature (flagship) | `[~]` In progress — Stage 1 closed (102/102+28/28); Stage 2a ballot engine model closed (105/105, `af9d9ec`); Stage 2b ballot voting UI closed 2026-07-13 (29/29, `7696245`: real tie/runoff verified end-to-end through the UI). Remaining: candidate detail popup, expiry notifications, tournament attendance display, live emulator walk (see phase doc) |
