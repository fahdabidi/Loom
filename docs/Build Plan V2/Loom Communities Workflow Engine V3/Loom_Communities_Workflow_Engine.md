...
| 1 | 1.18 Tournament + Voting feature (flagship) | `[~]` In progress — Stages 1/2a/2b closed; **ticketed-dispatch process adopted (2026-07-13, hard gate — no self-written code)**; attendance+RSVP ticket closed first attempt (30/30, `8a62c4d`). Remaining: candidate detail popup, expiry notifications, live emulator walk (see phase doc) |
