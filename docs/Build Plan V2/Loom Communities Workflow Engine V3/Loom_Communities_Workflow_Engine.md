...
| 1 | 1.18 Tournament + Voting feature (flagship) | `[~]` In progress — Stage 1 (async transition resolution) closed 2026-07-13, 102/102 + 28/28, commits `955268d`+`2a62d0a`; Stage 2 (full feature) + live emulator walk still pending (see phase doc) |
