...
| `wf_app-shell-persona-tabs-customization` | workflow | none | workflow-validation-harness, loom-communities-demo-app, community-card, app-shell-runtime, navigation-panel, role-policy-consent-engine | pass |
