...
- [ ] `new-ticket` — 11 pre-existing app-shell test failures (baseline `+227 -11`, unrelated to this effort); clear before Phase E — see [Access Control and Workflow Service Tracker.md §8](Access%20Control%20and%20Workflow%20Service%20Tracker.md)
