...
- [ ] authenticated walkthrough — device now carries 10 example communities (APK rebuilt with the preload define, verified on screen); sign-in is reachable but still unproven → Build Tracker §8
