...
- [ ] `needs-skill-dispatch` — Milestone 1.5 (Skill-dispatched JSON authoring, 7 communities) — 1 of 7 done (Garden Club), in progress one community at a time — see [TabId-Archetype Gap Closure.md §8](TabId-Archetype%20Gap%20Closure.md)
