...
- [ ] `new-ticket` — 11 app-shell test failures (baseline `+227 -11`) — **not** incidental rot as first recorded: 7 are the unbuilt response-row fan-out, 2 are a real Garden Club tab-derivation defect, 2 unexamined — see [Access Control and Workflow Service Tracker.md §8](Access%20Control%20and%20Workflow%20Service%20Tracker.md)
