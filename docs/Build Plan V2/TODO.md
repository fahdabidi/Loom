...
- [ ] `needs-debug-agent` — CJM.16: Member Social Space Messages-tab identity-matching gap — root-caused 2026-08-13 as a systemic identity-namespace gap affecting 10 of 11 communities, not a narrow bug; paused pending review of [`CJM.16 Identity Architecture Proposal.md`](CJM.16%20Identity%20Architecture%20Proposal.md) — see [Community JSON Migration Tracker.md §8](Community%20JSON%20Migration%20Tracker.md)
- [ ] `needs-debug-agent` — CJM.18: Data Portability Community cross-community sign-up state leak — root-caused 2026-08-13 (a real, statically-confirmed stale-closure defect found, full live-sequence not yet confirmed); paused, sequenced after CJM.16's architecture proposal — see [Community JSON Migration Tracker.md §8](Community%20JSON%20Migration%20Tracker.md)
