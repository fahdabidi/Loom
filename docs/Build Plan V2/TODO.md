...
- [ ] `blocked` — Milestone 1.5 (Skill-dispatched JSON authoring, 7 communities) — blocked on Milestone 1 — see [TabId-Archetype Gap Closure.md §8](TabId-Archetype%20Gap%20Closure.md)
