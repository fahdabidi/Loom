...
- [ ] authenticated walkthrough — Android interactive login is **built** (`7a69f845`, 736 insertions + `interactive_login_io_test.dart`); not yet proven by a real sign-in on device → Build Tracker §8
