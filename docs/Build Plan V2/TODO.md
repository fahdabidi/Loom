...
- [ ] `new-ticket` — 9 app-shell test failures (baseline `+229 -9`, was `+227 -11`) — **not** incidental rot: 7 are the unbuilt response-row fan-out, 2 unexamined; the 2 CJM.8 Garden Club failures are closed (membership never established in the fixture) — see [Access Control and Workflow Service Tracker.md §8](Access%20Control%20and%20Workflow%20Service%20Tracker.md)
