...
- [ ] `new-ticket` — 8 app-shell test failures (baseline `+231 -8`, was `+227 -11`) — **not** incidental rot: 7 are the unbuilt response-row fan-out, 1 is a probable Admin-tab access-control leak; CJM.8 (×2) and CJM.9 are closed — see [Access Control and Workflow Service Tracker.md §8](Access%20Control%20and%20Workflow%20Service%20Tracker.md)
