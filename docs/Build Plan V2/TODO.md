...
- [ ] `needs-skill-dispatch` — Milestone 1.5 (Skill-dispatched JSON authoring, 7 communities) — unblocked ahead of Milestone 1 by explicit user decision 2026-08-12, in progress one community at a time — see [TabId-Archetype Gap Closure.md §8](TabId-Archetype%20Gap%20Closure.md)
