...
Status: not started. **Not designed in detail yet, deliberately** â€” a fresh planning pass happens once
...
For each community: `Milestone 5.<n> â€” <Community> tab reimplementation`, following the same
