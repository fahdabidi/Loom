...
| mosque-volunteer-signup | Community member / Masjid admin | Home shift card; Calendar summary; Admin coordination | role, shift date/time, location, capacity/open spots, signup/contact-consent and follow-up histories | `sign-up-volunteer`, `update-volunteer-availability`, `cancel-volunteer-signup`, `record-coordinator-follow-up`, `close-volunteer-shift` | B14/B25 |
