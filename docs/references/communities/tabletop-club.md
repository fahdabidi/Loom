...
- **Targeted per-persona notifications — CAL.Notify, design closed 2026-07-26; engine + validator + fixture
  IMPLEMENTED 2026-07-31 (CAL.Notify.1-.3); App-Shell rendering + client-orchestrated fan-out still not
  implemented (CAL.Notify.4/.5/.6).** Real gap found during the Calendar audit, but cross-cutting
