...
void main() {
  test('actor derives from createdByPersonaId when no actorEqualsField exists', () {
  ...
  test('actor uses actorEqualsField when present, even over createdByPersonaId', () {
    final machine = _machine([
      <String, dynamic>{
        'id': 'approve',
        'label': 'Approve',
        ...
        'guard': <String, dynamic>{
          'actorEqualsField': <String, dynamic>{'key': 'payerPersonaId'},
        },
      },
    ]);
    final instance = _instance(
      ...
      instanceData: <String, dynamic>{'payerPersonaId': 'payer-persona'},
    );
    final roles = deriveInstanceRoles(
      machine,
      instance,
  ...
  test('viewer with matching allowedPersonaIds guard is receiver when not actor', () {
    final machine = _machine([
      <String, dynamic>{
        'id': 'approve',
        'label': 'Approve',
        ...
        'to': 'approved',
        'guard': <String, dynamic>{
          'allowedPersonaIds': <String>['board-role'],
        },
      },
    ]);
    final instance = _instance(
  ...
  test('viewer with no actor role and no passing guard is neither actor nor receiver', () {
    final machine = _machine([
      <String, dynamic>{
        'id': 'approve',
        'label': 'Approve',
