...
const _extensionId = 'ext_platform_social';
const _communityId = 'community_platform_social';
...
Directory _repositoryRoot() {
  ...
  throw StateError('Could not find the frozen Member Social Space fixture.');
}
...
Future<void> main() async {
  ...
  // extensionId (community_platform_social/ext_platform_social) so
