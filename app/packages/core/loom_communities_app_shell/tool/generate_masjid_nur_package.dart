...
const _extensionId = 'ext_mosque';
const _communityId = 'community_mosque';
...
Directory _repositoryRoot() {
  ...
  throw StateError('Could not find the frozen Masjid Nur fixture.');
}
...
Future<void> main() async {
  ...
  // extensionId (community_mosque/ext_mosque) so sideload hydrates that
  // shell (CJM.9's fix path) instead of creating a separate community.
