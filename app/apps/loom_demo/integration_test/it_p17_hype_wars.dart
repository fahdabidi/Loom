...
void main() {
  ...
  testWidgets('it_p17_hype_wars', (tester) async {
    ...
    expect(find.textContaining(r'$2.99', skipOffstage: false), findsWidgets);
    expect(
      find.textContaining('Simulated wallet', skipOffstage: false),
      findsWidgets,
    );
  });
}
