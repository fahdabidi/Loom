...
void main() {
  ...
  testWidgets('it_p4_multiformat_render', (tester) async {
    ...
    await tapDiscoveryKey(tester, 'p4_content_video_content_solar_001');
    ...
    await tapDiscoveryKey(tester, 'p4_content_post_content_solar_002');
    expect(find.byKey(const ValueKey('p4_post_view')), findsOneWidget);
  });
}
