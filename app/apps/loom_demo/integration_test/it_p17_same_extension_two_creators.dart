...
void main() {
  ...
  testWidgets('it_p17_same_extension_two_creators', (tester) async {
    ...
    expect(find.text('Ace retakes', skipOffstage: false), findsWidgets);

    await _pumpChannel(tester, 'creator_frame_by_frame');
    expect(find.text('Split saves', skipOffstage: false), findsWidgets);
  });
}
